...
export class SlsCommandError extends Error {
  ...
  constructor(
    ...
    super(message);
    // Restore the prototype chain: subclassing built-in Error under the
    // repo's `target: es5` otherwise leaves instances with Error.prototype,
    // breaking `instanceof SlsCommandError` and dropping custom fields.
    Object.setPrototypeOf(this, SlsCommandError.prototype);
